function [deltas,fracResp]=calcDeltaXphototroph(jN,jL,jDOC)
delta  = 0.05;
alphaN = 0.972;
alphaL = 0.3;
alphaF = 0.018;
...
for i = 1:this.n
    ...
    this.JN(i)   = jN(i).*this.m; % convert to ugN/day
    this.JDOC(i) = jDOC(i).*this.m;
    ...
    this.JF = 0;%this.flvl * fTemp2*this.JFmax;
