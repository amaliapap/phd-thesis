...
%
function panelRespirationA2(p,rates, iGroup,combinedLeg)
% 
...
%         jR_g
        ...
        totgro=fillbetweenlines(m, jR+jR_DOC+jR_L+jR_N+jR_F+jR_g, jR+jR_DOC+jR_L+jR_N+jR_F+jR_g+jTot,  palePink   );
...
%         jR_g = betaG*rates.jTot(ix);
        ...
        totgro=fillbetweenlines(m, jR+jR_DOC+jR_L+jR_N+jR_Si+jR_g, jR+jR_DOC+jR_L+jR_N+jR_Si+jR_g+max(0,jTot),  palePink  );
        ...
        legend({'Basal','DOC','Light','Nitrogen','Silicate','Synthesis costs','Division rate'});
        if combinedLeg
            set(legend,'visible','off')
        ...
        {'Basal','DOC','Light','Nitrogen','Feeding','Silicate','Synthesis costs','Division rate'}, ...
        'box','off');
